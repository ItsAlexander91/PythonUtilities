...
class Calculator(tk.Tk):
    def __init__(self):
        ...
        self.geometry("500x700")  # Updated size
    ...
    def create_widgets(self):
        ...
        # Clear Button
        clear_button = tk.Button(self, text='C', font=self.custom_font, bg="#d9534f", fg="#ffffff", relief=tk.RAISED, bd=0, width=5, height=2, command=lambda: self.on_button_click('C'))
        clear_button.pack(side=tk.BOTTOM, pady=10, padx=20, fill=tk.X)
